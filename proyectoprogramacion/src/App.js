...
import logo1 from './views/logo_usm.png';
import logo2 from './views/logo_scotiabank.png'
import logo3 from './views/logo_ripley.png'
import logo4 from './views/logo_accenture.png'
import logo5 from './views/logo_firstjob.png'
import logo from './views/logo_feria.png'
import {
                ...
                <nav className="navbar navbar-expand-lg "> 
                  ...
                  <div  data-target="#navbarSupportedContent" className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form className="form-inline my-2 my-lg-0" style={{marginRight:"14px"}}>
                      <Link onClick={this.handleChangeNone} to="/inscripcion"><button className="btn btn-warning my-2 my-sm-0 btn-rounded" type="submit" style={{color:"white"}}><i className="fas icono fa-award"></i> Vota por tu favorito</button></Link>
                    </form>
                  </div>
                </nav>
              </div>
