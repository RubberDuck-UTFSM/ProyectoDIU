...
import feria2 from './images/feria3.jpg';
        ...
        return (
            <>
                <div className=" bg-light">
                    <div className="jumbotron paralProyectos borde-abajo-proyectos" style={{ backgroundImage: `url(${feria1})` }}>
                        <div className="container-fluid overlay text-center">
                            <div className="container-proyectos " >
                                <h1 className="display-4 text-white text-left" style={{ fontSize: "1.5rem", marginLeft: "80px" }}>Proyectos <strong>Feria de Software 2020</strong></h1>
                                <h1 className="display-4 text-white text-left" style={{ fontSize: "3rem", marginLeft: "80px" }}>Categoría <strong >Inteligencia Artificial y Ciencia de Datos</strong></h1>
                                <br></br>
                                <br></br>
                                {carousel_IA}
                            </div>
                    ...
                    <div className="jumbotron paralProyectos" style={{ backgroundImage: `url(${feria2})` }}>
                        <div className="container-fluid overlay text-center">
                            <div className="container-proyectos " >
                                <h1 className="display-4 text-white text-left" style={{ fontSize: "1.5rem", marginLeft: "80px" }}>Proyectos <strong>Feria de Software 2020</strong></h1>
                                <h1 className="display-4 text-white text-left" style={{ fontSize: "3rem", marginLeft: "80px" }}>Categoría <strong className="">Transformación Digital y Social</strong></h1>
                                <br></br>
                                <br></br>
                                {carousel_TD}
                            </div>
